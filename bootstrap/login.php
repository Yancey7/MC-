...
?>
    ...
    <link rel="icon" href="pic/title1.png" sizes="16x16" type="pic/title1.png">
	<style>
    .fakeimg {
        height: 220px;
        background: #aaa;
    ...
    body{
      background: url(pic/title1.png) no-repeat;
...
<body>
<div class="jumbotron text-center" style="margin-bottom:0; background-image:url(pic/rqml/1.png)" >
  <h1>后台登录</h1>
