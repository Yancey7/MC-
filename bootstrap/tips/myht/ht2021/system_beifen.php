...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <form action="beifen.php" method="post" id="myform" name="myform">
                <div class="config-items">
                    <div class="config-title">
                        <h1><i class="icon-font">&#xe00a;</i>网站数据备份</h1>
                    </div>
                        ...
                        <table width="100%" class="insert-tab">
                            <tbody><tr>
                                ...
                                <tr>
                                    <th></th>
                                    <td>
                                        <input type="submit" value="确定" class="btn btn-primary btn6 mr10">
                                        <input type="button" value="取消" onClick="history.go(-1)" class="btn btn6">
                                    </td>
                                </tr>
                            </tbody></table>
                    </div>
