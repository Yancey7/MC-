...
<div class="jumbotron text-center" style="margin-bottom:0; background-image: url(image/bt1.png);background-size:100% 100%;">
  <h1 style="color:#FFF; font-size:86px;">我的第一个 Bootstrap 页面</h1>
  <p>重置浏览器窗口大小查看效果！</p> 
</div>
...
<div class="container">
  <div class="row">
   ...
   <div class="row">
        ...
        <h1 style="background-color:#CCC;">动态新闻</h1>
               <?php 
    ...
    <div class="row">
      ...
      <div class="row">
        <h1 style="background-color:#CCC;">热门点击排行</h1>
        <div class="col-sm-12"  style=" height:260px;">
             <?php 
			   			
						$sql1="SELECT *FROM news order by djcs desc limit 0,6";
						$result1=mysqli_query($con,$sql1);$x4=0;
			       while($row1=mysqli_fetch_array($result1,MYSQLI_NUM)){?>
                   <a href="newshow1.php?aaaid=<?php echo $row1[0];?>">
                   <div class="news3">
                         <div class="news31" style="<?php if($x4<3){echo "color:#F00";}else { echo "color:#000";}?>;"><?php 
						  if(strlen($row1[1])>=20){
      ...
      <div class="row">
      <h1 style="background-color:#CCC;">移动图片</h1>
        <div class="col-sm-12" >
