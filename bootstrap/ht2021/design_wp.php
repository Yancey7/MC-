...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="admin_index.php">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">物品一览</span></div>
        </div>
            ...
            <form name="myform" id="myform" method="post" action="delall_ok.php">
                <div class="result-title">
                    <div class="result-list">
                        <a href="insert_wp.php"><i class="icon-font"></i>新增数据</a>
                ...
                <div class="result-content">
                  <table class="result-tab" width="100%">
						...
						include_once("../conn/conn.php");
						$sql="SELECT *FROM wp order by id";
						$result=mysqli_query($con,$sql);
						// 数字数组
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="table" value="wp" type="hidden">
                            ...
                            <td></td>
                            <td>
                                <a class="link-update" href="edit_wp.php?id=<?php echo $row[0];?>">修改</a>
                                <a class="link-del" href="del_ok.php?id=<?php echo $row[0];?>&table=wp">删除</a>
                            </td>
                        </tr>
                        <?php }?>
                    ...
                    <tr><td colspan="12"></td></tr>
						...
						?>
						<a href="design_wp.php?page=1">首 页</a> | <a href="design_wp.php?page=<?php echo $page-1;?>">上 页</a>
						<?php }?>
						...
						?>
						<a href="design_wp.php?page=<?php echo $page+1;?>">下 页</a> | <a href="design_wp.php?page=<?php echo $totalpage;?>">尾 页</a>
						<?php }?></tr>
