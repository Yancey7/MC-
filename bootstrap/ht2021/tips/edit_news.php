...
?>
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="admin_index.php">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="insert_ok.php?table=news">new</a><span class="crumb-step">&gt;</span><span>修改</span></div>
        </div>
