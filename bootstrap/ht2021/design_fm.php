...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="admin_index.php">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">附魔</span></div>
        </div>
            ...
            <form name="myform" id="myform" method="post" action="delall_ok.php">
                <div class="result-title">
                    <div class="result-list">
                        <a href="insert_fm.php"><i class="icon-font"></i>新增数据</a>
                ...
                <div class="result-content">
                  <table class="result-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="table" value="fm" type="hidden">
                            ...
                            <td></td>
                            <td>
                                <a class="link-update" href="edit_fm.php?id=<?php echo $row[0];?>">修改</a>
                                <a class="link-del" href="del_ok.php?id=<?php echo $row[0];?>&table=fm">删除</a>
                            </td>
                        </tr>
                        <?php }?>
                    ...
                    <tr><td colspan="12"></td></tr>
						...
						?>
						<a href="design_fm.php?page=1">首 页</a> | <a href="design_fm.php?page=<?php echo $page-1;?>">上 页</a>
						<?php }?>
						...
						?>
						<a href="design_fm.php?page=<?php echo $page+1;?>">下 页</a> | <a href="design_fm.php?page=<?php echo $totalpage;?>">尾 页</a>
						<?php }?></tr>
