...
$sql="SELECT *FROM user order by id desc limit 1";//找出最后一条记录的id
...
$sql1="insert into yancey.user(id,name,pwd,level) values('$id','$name','$pwd','$level')";
$result=mysqli_query($con,$sql1);
//echo $sql1;

echo "<script>alert('数据成功添加！');location.href='admin_user.php';</script>";
