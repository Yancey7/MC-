...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="admin_index.php">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="design_fm.php">附魔</a><span class="crumb-step">&gt;</span><span>新增</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="insertall_ok.php?table=fm" method="post" id="myform" name="myform" enctype="multipart/form-data">
