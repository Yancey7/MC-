...
<?php
 	          include_once("conn/conn.php");
					   ...
					   //保存被点击文章的次数，先读出原来的点击次数，再加上1，再更新原来的值
						$sql23="SELECT *FROM fm where id='$id'";
  ...
  <div class="row">
    ...
    <div class="col-sm-8">
      ...
      <h3>附魔</h3><br>
      <h4>&nbsp; &nbsp; &nbsp; &nbsp;本文章介绍的是Minecraft中的游戏机制。关于Minecraft Dungeons中的游戏机制，请见“Minecraft Dungeons:附魔”。</h4><br>
      <h4>&nbsp; &nbsp; &nbsp; &nbsp;附魔（Enchanting）是为盔甲、工具、武器以及书添加魔咒（Enchantments）的游戏机制，这些魔咒可以添加或增强物品的特殊能力和效果，并赋予其光效（Glint）。</h4>
