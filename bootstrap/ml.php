...
<?php
 	          include_once("conn/conn.php");
					   ...
					   //保存被点击文章的次数，先读出原来的点击次数，再加上1，再更新原来的值
						$sql23="SELECT *FROM ml where id='$id'";
  ...
  <div class="row">
    ...
    <div class="col-sm-8">
      ...
      <h3>命令</h3><br>
      <h4>&nbsp; &nbsp; &nbsp; &nbsp;本文章介绍的是控制台命令。关于可以执行命令的方块，请见“命令方块”。关于可以执行命令的矿车，请见“命令方块矿车”。关于基岩版开发者测试命令，请见“基岩版开发者命令”。</h4><br>
      <h4>&nbsp; &nbsp; &nbsp; &nbsp;命令（Command），也被称作控制台命令（Console Command）或斜杠命令（Slash Command），是通过输入特定文本字符串而激活的高级功能。</h4>
      <ul class="nav nav-pills nav-stacked">
        <?php
              include_once("conn/conn.php");
              $sql="SELECT *FROM ml";
