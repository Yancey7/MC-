...
<?php
  ...
  <div class="row">
    ...
    <?php include_once("conn/conn.php");
          ...
          $sql2="SELECT *FROM sw order by id desc";
          ...
          if ($idaa>=$num){ 
            ...
            $idaa=$id+1;
                ...
                $sql6="SELECT *FROM sw where id='$idaa'";
          ...
          $sql66="SELECT *FROM sw where id='$idaa2'";
    ...
    <tr width="369" height="97">
      <td><img src="<?php echo "pic/sw/".$row[3];?>" style="width:100%; height:100%;"></td>
    </tr>
    <tr>
      <td>
    ...
    <tr height="50">
      <td style="font-size:18px">&nbsp;上一篇：<a href="swnew.php?id=<?php echo $row66[0];?>&a=s&b=t"><?php 
      echo $row66[1];
      ?></a>&nbsp;&nbsp;&nbsp;&nbsp;下一篇：<a href="swnew.php?id=<?php echo $row6[0];?>&a=s&b=t"><?php 
      echo $row6[1];?></a></td>
    </tr>
    <?php }?>
